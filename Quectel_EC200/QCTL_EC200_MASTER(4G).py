# ==========================================================
# QUECTEL EC200U "FULL AUTO WITH PHYSICAL SIM" FRAMEWORK
# ==========================================================
# Features:
...
def send_at(ser, command, timeout=3):
    ...
    try:
        ...
        time.sleep(2.0) # ADDED DELAY: Mandatory buffer cooldown after every AT command for Quectel
    ...
    while True:
        ...
        try:
            ...
            if state == "SIM":
                ...
                time.sleep(10) # ADDED DELAY: Increased from 5 to 10 for loop stability
