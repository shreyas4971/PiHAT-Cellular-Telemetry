# =====================================================================
# SIMCOM A7672S "FULL AUTO WITH PHYSICAL SIM" FRAMEWORK
# =====================================================================
# Features:
# - Physical SIM MUX Routing (GPIO 5 locked LOW)
    ...
    while True:
        try:
            ...
            if state == "SIM":
                ...
                payload = f"[{timestamp}] SIMCom A7672S (4G Physical) | Msg #{msg_count}"
